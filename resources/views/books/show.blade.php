        ...
        d="M36.75,8.5V35c0,1.104-0.895,2-2,2H8.25c-1.104,0-2-0.896-2-2V8.5c0-1.104,0.896-2,2-2h26.5   C35.855,6.5,36.75,7.396,36.75,8.5z M30.75,2c0-1.104-0.895-2-2-2H2.25c-1.104,0-2,0.896-2,2v26.5c0,1.104,0.896,2,2,2   c1.105,0,2-0.896,2-2V4h24.5C29.855,4,30.75,3.104,30.75,2z"/>
                    ...
                    <div id="reviews">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Excelente guía para mejorar la calidad del
                                    código</p>
                                <p class="text-base text-gray-500">Este libro me ha ayudado enormemente a escribir código
                                    más
                                    limpio
                            ...
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Imprescindible para cualquier programador</p>
                                <p class="text-base text-gray-500">Este libro es una joya. Ofrece consejos prácticos y
                                    perspectivas únicas sobre el arte de programar. Me ha ayudado a mejorar mis habilidades
                                    de
                                    resolución de problemas y a adoptar un enfoque más pragmático en mi trabajo. Es un libro
                                    que
                            ...
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Guía esencial para el diseño de software</p>
                                <p class="text-base text-gray-500">Este libro es un tesoro de conocimiento sobre patrones de
                                    diseño. Las explicaciones son claras y los ejemplos prácticos son muy útiles para
                                    comprender
